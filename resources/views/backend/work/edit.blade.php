            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Blogs Edit Form
                            <div class="page-title-subheading">Edit {{$blog->title}}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <form action="{{route('backend.blog.update',$blog->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-1">
                                        <img style="width: 65px;height: 65px;border-radius: 8px; box-shadow: 0 0 5px 2px;" src="{{$blog->image}}" alt="">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-check form-check-inline text-success font-weight-bold">
                                            <label class="form-check-label">
                                                <input {{$blog->status == 1 ? 'checked' : ''}} type="radio" name="status" value="1" class="bg-success form-check-input @error('status') is-invalid @enderror">
                                                Published
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline text-danger font-weight-bold">
                                            <label class="form-check-label">
                                                <input {{$blog->status == 0 ? 'checked' : ''}} type="radio"  name="status" value="0" class="bg-danger form-check-input  @error('status') is-invalid @enderror">
                                                Unpublished
                                            </label>
                                        </div>
                                        @error('status')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <button class="btn btn-success btn-lg" type="submit" value="">Update Blog</button>
                                    </div>
                                </div>
                            </form>
                        </div>
